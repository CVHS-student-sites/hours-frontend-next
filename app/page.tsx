...
import { Clock, CheckCircle, TrendingUp, QrCode, Users, Shield, Sparkles } from "lucide-react"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <GradientCard variant="default" className="p-6 h-full transition-all duration-200">
